...
export default function Header() {
  ...
  return (
    <header className="fixed left-1/2  -translate-x-1/2 max-w-[820px] w-full rounded-[100px]  flex justify-between items-center top-5  bg-brand text-white px-4 py-3 z-20">
      <h1
